...
b.parse){var f;a:{try{var g=new Date("2014-01-01 "+a);f={hour:g.getHours(),minutes:g.getMinutes(),seconds:g.getSeconds(),millisec:g.getMilliseconds(),timezone:e.timepicker.timeZoneOffsetString(g)};break a}catch(i){try{f=d(c,a,b);break a}catch(h){e.datepicker.log("Unable to parse \ntimeString: "+a+"\ntimeFormat: "+c)}}f=!1}return f}return d(c,a,b)};e.datepicker.formatTime=function(c,a,b){var b=b||{},b=e.extend({},e.timepicker._defaults,b),a=e.extend({hour:0,minute:0,second:0,millisec:0,timezone:"+0000"},
